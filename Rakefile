...
namespace :site do
  ...
  task :publish => [:generate, :minify, :optimizeimages] do
    Dir.mktmpdir do |tmp|
      cp_r "_site/.", tmp
      ...
      system "git init"
      system "git remote add upstream git@github.com:#{GB_REPONAME}.git"
      system "git fetch upstream"
      system "git reset upstream/gh_pages"
      system "touch ."
      system "git add -A ."
      system "git commit -m #{message.inspect}"
      system "git remote add origin git@github.com:#{GB_REPONAME}.git"
      system "git push -q upstream HEAD:gh_pages"
...
# Older code b/w Dir.chdir tmp & Dir.chdir pwd
#      system "git init"
#      system "git add ."
#      message = "Site updated at #{Time.now.utc}"
#      system "git commit -m #{message.inspect}"
#      system "git remote add origin git@bitbucket.org:#{BB_REPONAME}.git"
#      system "git push origin master:refs/heads/pages --force"